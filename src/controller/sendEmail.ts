...
const sendEmail = async (email:string,firstName:string,verifyToken:string) => {
    await transporter.sendMail({
        ...
        html:`      <div style="font-family: Arial, sans-serif; background-color: #F4F4F4; padding: 20px;">
                    ...
                    <a href="https://khalil-dev.me/user/verify_account/${verifyToken}" style="display: inline-block; padding: 10px 20px; background-color: #007BFF; color: #fff; text-decoration: none; border-radius: 5px;">Verify Account</a>
                </div>`
